...
# DISCLAIMER:
# Large parts of this code file were originally forked from
# https://github.com/williamleif/GraphSAGE
# which itself was very inspired by the GCN package

######################################################################
input_log_device_placement = False # """Whether to log device placement.""" 
#core params..
input_model         = 'graphsage_mean' # 'model names. See README for possible values.'
input_learning_rate = 0.00001 #, 'initial learning rate.')
input_model_size    = "small" # "Can be big or small; model specific def'ns")
input_train_prefix = '' # 'name of the object file that stores the training data. must be specified.')
...
input_dim_1 = 128 #, 'Size of output dim (final is 2x this, if using concat)')
input_dim_2 = 128 #, 'Size of output dim (final is 2x this, if using concat)')
...
input_batch_size = 512 #, 'minibatch size.')
input_n2v_test_epochs = 1 #, 'Number of new SGD epochs for n2v.')
input_identity_dim = 10 #, 'Set to positive value to use identity embedding features of that dimension. Default 0.')
...
input_max_total_steps = 1000  #, "Maximum total number of iterations")
######################################################################
...
class SampleAndAggregate(GeneralizedModel):
    ...
    def __init__(self, placeholders, features, adj, degrees,
            ...
            model_size="small", identity_dim=10,
            **kwargs):
        '''
        Args:
